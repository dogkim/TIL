...
- $F \subseteq Q$ : 종료 상태의 집합, 입력이 끝났을 때 이 상태에 도달해있어야 정상

### Extended Transition Function
**Definition** :
$\delta^* : Q \times \Sigma^* \to Q$
$\delta^*$의 두번째 Argument는 String이고, $\delta^*$의 값은 이 String을 읽고 난 후의 Automaton의 State를 나타낸다
...
DFA에서 만들 수 있는 모든 String중 start string에서 시작해서 F state으로 끝나는 경우의 string
## Regular Language
